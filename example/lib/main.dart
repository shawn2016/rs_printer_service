...
String templateXml = "";
                  Future<dynamic> fetchPrintTemplate() async {
                    final headers = {
                      'vulcan-token': 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJsb2dpblR5cGUiOiJsb2dpbiIsImxvZ2luSWQiOiJob25neXVhbiIsInJuU3RyIjoiVW9GbGtlRkxyQ21qeXZYbEtYVzFMTDY5bE9wQlNUc3UiLCJ1c2VyTmFtZSI6Iui1tea0qua6kCJ9.RxXSeKpPikj3rAxA4b8wNrZS8zgpEspm82dpcfmvpRE',
                      'corporation-id': '256',
                    ...
                    try {
                      final response = await http.post(
                        Uri.parse('https://bo.test.restosuite.ai/api/print/template/management/query/freemarker'),
                        headers: headers,
                        body: body,
                      );
                      ...
                      if (response.statusCode == 200) {
                        ...
                        print('请求失败: ${response.statusCode}, ${response.reasonPhrase}');
    ...
    templateXml = templateXml.replaceAll(r'\"', '"');
                  ...
                  final data = <String, dynamic>{
                    ...
                    'queueTypeName': '普通桌',
                    'queueNum': 'A12',
                    'printTime':DateFormat('yyyy-MM-dd HH:mm:ss').format(DateTime.now())
                  };
